namespace Serenity.Administration {
    export namespace UserPermissionService {
        ...
        export declare function ListPermissionKeys(request: ServiceRequest, onSuccess?: (response: Serenity.ListResponse<string>) => void, opt?: Q.ServiceOptions<any>): JQueryXHR;
