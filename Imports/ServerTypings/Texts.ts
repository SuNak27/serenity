namespace App.Texts {
    ...
    declare namespace Db {
        ...
        namespace MasterData {
            ...
            namespace Pelanggaran {
                export const Id: string;
                export const IdSiswa: string;
                export const Keterangan: string;
                export const Pelanggaran: string;
                export const TglPelanggaran: string;
            }

            namespace Siswa {
                export const DetailPelanggaran: string;
                export const Id: string;
                export const KotaAsal: string;
                export const Nama: string;
                export const Nis: string;
                export const TglLahir: string;
                export const Umur: string;
            }
        }
    }
