    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your Serenity Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your Serenity Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "Serenity";
        }
